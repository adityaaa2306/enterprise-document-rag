...
const STEPS = [
  {
    ...
    status: "attempt",
    icon: null,
    body: "Chunk sent to light tier based on complexity 0.31 and clean grid signal.",
  },
  {
    n: "02",
    ...
    status: "reject",
    icon: X,
    body: "Output confidence below 0.72 threshold. Bounded escalation triggers.",
  },
  {
    n: "03",
    ...
    status: "accept",
    icon: Check,
    body: "Re-routed to medium tier. Passed at 0.91 — logged for cost accounting.",
  },
];
