...
export default function SystemOverview() {
  return (
    <section id="system" data-testid="system-overview" className="relative py-24 md:py-32 hairline-t bg-[#070707]">
          ...
          {CARDS.map((c, i) => {
            ...
            return (
              <motion.div
                ...
                className="group relative border border-white/10 bg-[#080808] p-8 hover:border-emerald-500/40 transition-colors"
              >
